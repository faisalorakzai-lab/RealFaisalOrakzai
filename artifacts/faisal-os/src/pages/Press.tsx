import { motion, AnimatePresence } from "framer-motion";
    ...
    const schema = {
      ...
      "@graph": [
        ...
        ...articles.map((a) => ({
          ...
          "keywords": "Faisal Orakzai, Muhammad Faisal Orakzai, Orakzai Group, OKBOND, blockchain Pakistan, Polygon, فیصل اورکزئی",
          "inLanguage": "en",
  ...
  export default function Press() {
    ...
    useEffect(() => {
      ...
      document.title = "Press Room — Faisal Orakzai | Orakzai Group Media Coverage | فیصل اورکزئی";
      const ogTitle = document.querySelector('meta[property="og:title"]');
      if (ogTitle) ogTitle.setAttribute("content", "Press Room — Muhammad Faisal Orakzai | Stevie Gold Award Winner | فیصل اورکزئی");
          ...
          <div className="max-w-7xl mx-auto px-6">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              ...
              <p className="text-white/40 font-mono text-sm mt-3 pb-8">
                Media coverage · Awards · Verified mentions — Muhammad Faisal Orakzai, فیصل اورکزئی
              </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-[#F3BA2F]/10">
              {[
                ...
                <div key={label} className="py-6 px-6 text-center">
                  <div className="text-2xl font-bold gold-gradient font-mono">{val}</div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: "Languages", value: "English · اردو · Pashto" },
