          ...
          <section className="border-t border-[#F3BA2F]/10">
            <div className="max-w-7xl mx-auto px-6 py-16">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-[#F3BA2F]/6">
                ...
                {/* High-Res Headshot */}
                <motion.a href="https://faisalorakzai.com/faisal-official-knowledge-panel.jpg" download="faisal-orakzai-headshot.jpg" target="_blank" rel="noopener noreferrer"
                  initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}
                  className="group bg-black p-6 flex flex-col gap-4 hover:bg-[#0a0a00] transition-colors"
                >
                  <div className="flex items-start justify-between">
                    <div className="w-10 h-10 border border-[#F3BA2F]/25 overflow-hidden">
                      <img src="https://faisalorakzai.com/faisal-official-knowledge-panel.jpg" alt="Faisal Orakzai" className="w-full h-full object-cover opacity-70 group-hover:opacity-100 transition-opacity object-top" />
                    </div>
