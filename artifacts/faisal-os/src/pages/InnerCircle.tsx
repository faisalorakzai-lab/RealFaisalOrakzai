...
function Tier1Card({ userName, memberId, userPhotoUrl, userSignatureUrl, issueDate, expiryDate, qrDataUrl }: CardProps) {
  return (
    <div style={{
      ...
      border: "1px solid rgba(6,182,212,0.35)", borderRadius: 20,
      boxShadow: "0 0 40px rgba(6,182,212,0.12), inset 0 0 60px rgba(6,182,212,0.03)",
      padding: 26, color: "#fff", userSelect: "none",
    }}>
      {/* Grid bg */}
      <div style={{ position:"absolute",inset:0,opacity:0.07,borderRadius:20,backgroundImage:"linear-gradient(to right,#22d3ee 1px,transparent 1px),linear-gradient(to bottom,#22d3ee 1px,transparent 1px)",backgroundSize:"20px 20px" }} />
      {/* Watermark */}
      <div style={{ position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",opacity:0.04,pointerEvents:"none",overflow:"hidden" }}>
        <span style={{ fontSize:10,letterSpacing:"0.3em",color:"#06b6d4",fontWeight:900,transform:"rotate(-15deg)",whiteSpace:"nowrap" }}>OFFICIAL INTEGRITY · ORAKZAI GROUP · OFFICIAL INTEGRITY · ORAKZAI GROUP</span>
      </div>
      {/* Header */}
      <div style={{ display:"flex",justifyContent:"space-between",alignItems:"flex-start",position:"relative",zIndex:10 }}>
        <div>
          <div style={{ fontSize:9,color:"#06b6d4",fontWeight:900,letterSpacing:"0.2em",textTransform:"uppercase" }}>OkzByte Hub</div>
          <div style={{ fontSize:7,color:"rgba(255,255,255,0.35)",letterSpacing:"0.1em",marginTop:2 }}>Silicon Valley Network // Tier 01 — Matrix Developer</div>
        </div>
        <img src="/logos/okzbyte.png" style={{ width:44,height:44,objectFit:"contain",filter:"drop-shadow(0 0 6px rgba(6,182,212,0.5))",borderRadius:10,background:"rgba(6,182,212,0.08)",padding:4,border:"1px solid rgba(6,182,212,0.2)",marginTop:-4,marginRight:-4 }} />
      </div>
      {/* Main */}
      <div style={{ display:"flex",alignItems:"center",gap:18,marginTop:18,position:"relative",zIndex:10 }}>
        <div style={{ width:90,height:90,borderRadius:12,border:"1.5px solid rgba(6,182,212,0.45)",background:"rgba(15,15,25,0.9)",overflow:"hidden",flexShrink:0,display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 0 18px rgba(6,182,212,0.08)" }}>
          {userPhotoUrl ? <img src={userPhotoUrl} style={{ width:"100%",height:"100%",objectFit:"cover" }} /> : <span style={{ fontSize:26,fontWeight:900,color:"#06b6d4" }}>{(userName||"?")[0].toUpperCase()}</span>}
        </div>
        <div style={{ flex:1,minWidth:0 }}>
          <div style={{ fontSize:17,fontWeight:900,color:"#f1f5f9",letterSpacing:"0.07em",textTransform:"uppercase",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap" }}>{userName||"IDENTITY NAME"}</div>
          <div style={{ marginTop:5,display:"inline-block",fontSize:8,color:"#06b6d4",fontWeight:700,letterSpacing:"0.15em",background:"rgba(6,182,212,0.08)",border:"1px solid rgba(6,182,212,0.2)",padding:"2px 8px",borderRadius:4 }}>{memberId||"OKZ-2026-0000"}</div>
          <div style={{ marginTop:6,fontSize:7,color:"rgba(255,255,255,0.3)",letterSpacing:"0.1em",textTransform:"uppercase" }}>MATRIX DEVELOPER · VERIFIED MEMBER</div>
        </div>
        {qrDataUrl && <div style={{ flexShrink:0,width:64,height:64,background:"white",borderRadius:5,padding:3,boxShadow:"0 0 10px rgba(6,182,212,0.2)" }}><img src={qrDataUrl} style={{ width:"100%",height:"100%",imageRendering:"pixelated" }} /></div>}
      </div>
      {/* Bottom */}
      <div style={{ position:"absolute",bottom:20,left:26,right:26,display:"flex",justifyContent:"space-between",alignItems:"flex-end",zIndex:10 }}>
        <div style={{ display:"flex",flexDirection:"column",gap:3 }}>
          <img src={FOUNDER_SIG_B64} style={{ height:30,maxWidth:100,objectFit:"contain",filter:"invert(1) brightness(0.7) sepia(1) hue-rotate(160deg) saturate(3)" }} />
          <div style={{ fontSize:6,color:"rgba(255,255,255,0.3)",fontWeight:700,letterSpacing:"0.12em",textTransform:"uppercase" }}>ISSUING AUTHORITY: F. ORAKZAI</div>
          <div style={{ display:"flex",gap:10,fontSize:6,color:"rgba(255,255,255,0.3)",letterSpacing:"0.08em",textTransform:"uppercase" }}>
            <span>ISSUE: <span style={{ color:"rgba(255,255,255,0.5)" }}>{issueDate}</span></span>
            <span>EXPIRY: <span style={{ color:"rgba(255,255,255,0.5)" }}>{expiryDate}</span></span>
          </div>
        </div>
        <div style={{ display:"flex",flexDirection:"column",alignItems:"flex-end",gap:5 }}>
          <div style={{ height:36,width:105,position:"relative",background:"rgba(15,15,25,0.3)",border:"1px solid rgba(255,255,255,0.07)",borderRadius:4,display:"flex",alignItems:"center",justifyContent:"center" }}>
            {userSignatureUrl && <img src={userSignatureUrl} style={{ height:28,maxWidth:95,objectFit:"contain",filter:"brightness(1.2) hue-rotate(140deg)" }} />}
            {!userSignatureUrl && <span style={{ fontSize:6,color:"rgba(6,182,212,0.25)",letterSpacing:"0.05em",fontFamily:"monospace" }}>MEMBER SIGNATURE</span>}
            <span style={{ position:"absolute",bottom:2,right:3,fontSize:5,color:"rgba(255,255,255,0.2)",letterSpacing:"0.04em" }}>AUTHORIZED</span>
          </div>
          <div style={{ width:38,height:28,borderRadius:4,background:"linear-gradient(135deg,#1e2030 0%,#2a2d45 50%,#1a1d2e 100%)",border:"1px solid rgba(6,182,212,0.3)",position:"relative",overflow:"hidden" }}>
...
function Tier2Card({ userName, memberId, userPhotoUrl, userSignatureUrl, issueDate, expiryDate, qrDataUrl }: CardProps) {
  return (
    <div style={{
      ...
      <div style={{ position:"absolute",inset:0,opacity:0.05,borderRadius:20,backgroundImage:"radial-gradient(#f59e0b 1px,transparent 1px)",backgroundSize:"18px 18px" }} />
      <div style={{ position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",opacity:0.04,pointerEvents:"none",overflow:"hidden" }}>
        <span style={{ fontSize:10,letterSpacing:"0.3em",color:"#f59e0b",fontWeight:900,transform:"rotate(-15deg)",whiteSpace:"nowrap" }}>OFFICIAL INTEGRITY · ORAKZAI GROUP · OFFICIAL INTEGRITY · ORAKZAI GROUP</span>
      </div>
      <div style={{ display:"flex",justifyContent:"space-between",alignItems:"flex-start",position:"relative",zIndex:10 }}>
        <div>
          <div style={{ fontSize:9,color:"#f59e0b",fontWeight:900,letterSpacing:"0.2em",textTransform:"uppercase" }}>OkzByte Hub</div>
          <div style={{ fontSize:7,color:"rgba(255,255,255,0.4)",letterSpacing:"0.1em",marginTop:2 }}>Silicon Valley Network // Tier 02 — Enterprise Architect</div>
        </div>
        <img src="/logos/okzbyte.png" style={{ width:44,height:44,objectFit:"contain",filter:"drop-shadow(0 0 6px rgba(245,158,11,0.5))",borderRadius:10,background:"rgba(245,158,11,0.08)",padding:4,border:"1px solid rgba(245,158,11,0.25)",marginTop:-4,marginRight:-4 }} />
      </div>
      <div style={{ display:"flex",alignItems:"center",gap:18,marginTop:18,position:"relative",zIndex:10 }}>
        <div style={{ width:90,height:90,borderRadius:12,border:"1.5px solid rgba(245,158,11,0.5)",background:"rgba(20,15,5,0.9)",overflow:"hidden",flexShrink:0,display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 0 18px rgba(245,158,11,0.1)" }}>
          {userPhotoUrl ? <img src={userPhotoUrl} style={{ width:"100%",height:"100%",objectFit:"cover" }} /> : <span style={{ fontSize:26,fontWeight:900,color:"#f59e0b" }}>{(userName||"?")[0].toUpperCase()}</span>}
        </div>
        <div style={{ flex:1,minWidth:0 }}>
          <div style={{ fontSize:17,fontWeight:900,color:"#fef3c7",letterSpacing:"0.07em",textTransform:"uppercase",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap" }}>{userName||"IDENTITY NAME"}</div>
          <div style={{ marginTop:5,display:"inline-block",fontSize:8,color:"#f59e0b",fontWeight:700,letterSpacing:"0.15em",background:"rgba(245,158,11,0.08)",border:"1px solid rgba(245,158,11,0.25)",padding:"2px 8px",borderRadius:4 }}>{memberId||"OKZ-2026-0000"}</div>
          <div style={{ marginTop:6,fontSize:7,color:"rgba(255,255,255,0.3)",letterSpacing:"0.1em",textTransform:"uppercase" }}>ENTERPRISE ARCHITECT · VERIFIED MEMBER</div>
        </div>
        {qrDataUrl && <div style={{ flexShrink:0,width:64,height:64,background:"white",borderRadius:5,padding:3,boxShadow:"0 0 10px rgba(245,158,11,0.2)" }}><img src={qrDataUrl} style={{ width:"100%",height:"100%",imageRendering:"pixelated" }} /></div>}
      </div>
      <div style={{ position:"absolute",bottom:20,left:26,right:26,display:"flex",justifyContent:"space-between",alignItems:"flex-end",zIndex:10 }}>
        <div style={{ display:"flex",flexDirection:"column",gap:3 }}>
          <img src={FOUNDER_SIG_B64} style={{ height:30,maxWidth:100,objectFit:"contain",filter:"sepia(1) brightness(1.3) hue-rotate(5deg) saturate(4)" }} />
          <div style={{ fontSize:6,color:"rgba(255,255,255,0.3)",fontWeight:700,letterSpacing:"0.12em",textTransform:"uppercase" }}>ISSUING AUTHORITY: F. ORAKZAI</div>
          <div style={{ display:"flex",gap:10,fontSize:6,color:"rgba(255,255,255,0.3)",letterSpacing:"0.08em",textTransform:"uppercase" }}>
            <span>ISSUE: <span style={{ color:"rgba(255,255,255,0.5)" }}>{issueDate}</span></span>
            <span>EXPIRY: <span style={{ color:"rgba(255,255,255,0.5)" }}>{expiryDate}</span></span>
        ...
        <div style={{ display:"flex",flexDirection:"column",alignItems:"flex-end",gap:5 }}>
          <div style={{ height:36,width:105,position:"relative",background:"rgba(20,15,5,0.3)",border:"1px solid rgba(255,255,255,0.07)",borderRadius:4,display:"flex",alignItems:"center",justifyContent:"center" }}>
            {userSignatureUrl && <img src={userSignatureUrl} style={{ height:28,maxWidth:95,objectFit:"contain",filter:"sepia(1) brightness(1.4) saturate(3) hue-rotate(15deg)" }} />}
            {!userSignatureUrl && <span style={{ fontSize:6,color:"rgba(245,158,11,0.25)",letterSpacing:"0.05em",fontFamily:"monospace" }}>MEMBER SIGNATURE</span>}
            <span style={{ position:"absolute",bottom:2,right:3,fontSize:5,color:"rgba(255,255,255,0.2)",letterSpacing:"0.04em" }}>AUTHORIZED</span>
          </div>
          <div style={{ width:38,height:28,borderRadius:4,background:"linear-gradient(135deg,#78350f 0%,#92400e 50%,#713f12 100%)",border:"1px solid rgba(245,158,11,0.3)",position:"relative",overflow:"hidden" }}>
            <div style={{ position:"absolute",top:"33%",left:0,right:0,height:1,background:"rgba(245,158,11,0.3)" }} />
            <div style={{ position:"absolute",top:"66%",left:0,right:0,height:1,background:"rgba(245,158,11,0.3)" }} />
            <div style={{ position:"absolute",left:"50%",top:0,bottom:0,width:1,background:"rgba(245,158,11,0.3)" }} />
          </div>
        </div>
      </div>
    </div>
...
function Tier3Card({ userName, memberId, userPhotoUrl, userSignatureUrl, issueDate, expiryDate, qrDataUrl }: CardProps) {
  return (
    <div style={{
      ...
      border:"1px solid rgba(200,200,200,0.5)",borderRadius:20,
      boxShadow:"0 0 50px rgba(255,255,255,0.08),inset 0 0 60px rgba(255,255,255,0.02)",
      padding:26,color:"#fff",userSelect:"none",
    }}>
      <div style={{ position:"absolute",inset:0,opacity:0.12,borderRadius:20,overflow:"hidden",backgroundImage:"linear-gradient(45deg,#1f1f1f 25%,transparent 25%,transparent 75%,#1f1f1f 75%,#1f1f1f),linear-gradient(45deg,#1f1f1f 25%,transparent 25%,transparent 75%,#1f1f1f 75%,#1f1f1f)",backgroundSize:"24px 24px",backgroundPosition:"0 0,12px 12px" }} />
      <div style={{ position:"absolute",inset:0,borderRadius:20,opacity:0.08,background:"linear-gradient(135deg,rgba(255,255,255,0.15) 0%,transparent 40%,rgba(255,255,255,0.05) 60%,transparent 100%)",pointerEvents:"none" }} />
      <div style={{ position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",opacity:0.04,pointerEvents:"none",overflow:"hidden" }}>
        <span style={{ fontSize:10,letterSpacing:"0.3em",color:"#ffffff",fontWeight:900,transform:"rotate(-15deg)",whiteSpace:"nowrap" }}>OFFICIAL INTEGRITY · ORAKZAI GROUP · OFFICIAL INTEGRITY · ORAKZAI GROUP</span>
      </div>
      <div style={{ display:"flex",justifyContent:"space-between",alignItems:"flex-start",position:"relative",zIndex:10 }}>
        <div>
          <div style={{ fontSize:9,color:"rgba(255,255,255,0.85)",fontWeight:900,letterSpacing:"0.2em",textTransform:"uppercase" }}>OkzByte Hub</div>
          <div style={{ fontSize:7,color:"rgba(255,255,255,0.4)",letterSpacing:"0.1em",marginTop:2 }}>Silicon Valley Network // Tier 03 Elite — Sovereign Founder</div>
        </div>
        <img src="/logos/okzbyte.png" style={{ width:44,height:44,objectFit:"contain",filter:"contrast(1.2) brightness(0.9)",borderRadius:10,background:"rgba(255,255,255,0.04)",padding:4,border:"1px solid rgba(200,200,200,0.35)",marginTop:-4,marginRight:-4 }} />
      </div>
      <div style={{ display:"flex",alignItems:"center",gap:18,marginTop:18,position:"relative",zIndex:10 }}>
        <div style={{ width:90,height:90,borderRadius:12,border:"1.5px solid rgba(200,200,200,0.6)",background:"rgba(15,15,15,0.95)",overflow:"hidden",flexShrink:0,display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 0 30px rgba(255,255,255,0.1)" }}>
          {userPhotoUrl ? <img src={userPhotoUrl} style={{ width:"100%",height:"100%",objectFit:"cover" }} /> : <span style={{ fontSize:26,fontWeight:900,color:"rgba(255,255,255,0.7)" }}>{(userName||"?")[0].toUpperCase()}</span>}
        </div>
        <div style={{ flex:1,minWidth:0 }}>
          <div style={{ fontSize:17,fontWeight:900,color:"#ffffff",letterSpacing:"0.07em",textTransform:"uppercase",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap" }}>{userName||"IDENTITY NAME"}</div>
          <div style={{ marginTop:5,display:"inline-block",fontSize:8,color:"rgba(255,255,255,0.8)",fontWeight:700,letterSpacing:"0.15em",background:"rgba(255,255,255,0.05)",border:"1px solid rgba(200,200,200,0.3)",padding:"2px 8px",borderRadius:4,boxShadow:"0 0 10px rgba(255,255,255,0.05)" }}>{memberId||"OKZ-2026-0000"}</div>
          <div style={{ marginTop:6,fontSize:7,color:"rgba(255,255,255,0.35)",letterSpacing:"0.1em",textTransform:"uppercase" }}>SOVEREIGN FOUNDER · ELITE MEMBER</div>
        </div>
        {qrDataUrl && <div style={{ flexShrink:0,width:64,height:64,background:"white",borderRadius:5,padding:3,boxShadow:"0 0 14px rgba(255,255,255,0.15)" }}><img src={qrDataUrl} style={{ width:"100%",height:"100%",imageRendering:"pixelated" }} /></div>}
      </div>
      <div style={{ position:"absolute",bottom:20,left:26,right:26,display:"flex",justifyContent:"space-between",alignItems:"flex-end",zIndex:10 }}>
        <div style={{ display:"flex",flexDirection:"column",gap:3 }}>
          <img src={FOUNDER_SIG_B64} style={{ height:30,maxWidth:100,objectFit:"contain",filter:"invert(1) brightness(0.85)" }} />
          <div style={{ fontSize:6,color:"rgba(255,255,255,0.3)",fontWeight:700,letterSpacing:"0.12em",textTransform:"uppercase" }}>ISSUING AUTHORITY: F. ORAKZAI</div>
          <div style={{ display:"flex",gap:10,fontSize:6,color:"rgba(255,255,255,0.3)",letterSpacing:"0.08em",textTransform:"uppercase" }}>
            <span>ISSUE: <span style={{ color:"rgba(255,255,255,0.5)" }}>{issueDate}</span></span>
            <span>EXPIRY: <span style={{ color:"rgba(255,255,255,0.5)" }}>{expiryDate}</span></span>
        ...
        <div style={{ display:"flex",flexDirection:"column",alignItems:"flex-end",gap:5 }}>
          <div style={{ height:36,width:105,position:"relative",background:"rgba(10,10,10,0.4)",border:"1px solid rgba(255,255,255,0.09)",borderRadius:4,display:"flex",alignItems:"center",justifyContent:"center" }}>
            {userSignatureUrl && <img src={userSignatureUrl} style={{ height:28,maxWidth:95,objectFit:"contain",filter:"brightness(1.5) contrast(1.2)" }} />}
            {!userSignatureUrl && <span style={{ fontSize:6,color:"rgba(200,200,200,0.25)",letterSpacing:"0.05em",fontFamily:"monospace" }}>MEMBER SIGNATURE</span>}
            <span style={{ position:"absolute",bottom:2,right:3,fontSize:5,color:"rgba(255,255,255,0.2)",letterSpacing:"0.04em" }}>AUTHORIZED</span>
          </div>
          <div style={{ width:38,height:28,borderRadius:4,background:"linear-gradient(135deg,#1f1f1f 0%,#333 50%,#1a1a1a 100%)",border:"1px solid rgba(200,200,200,0.3)",position:"relative",overflow:"hidden" }}>
